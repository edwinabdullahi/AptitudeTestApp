package com.edwareinc.myexamapp;
...
import com.edwareinc.myexamapp.QuizContract.*;
...
public class QuizDbHelper extends SQLiteOpenHelper {
    private static final String DATABASE_NAME = "MyExamApp.db";
    ...
    public void onCreate(SQLiteDatabase db) {
        this.db = db;
        final String SQL_CREATE_CAREGORIES_TABLE = "CREATE TABLE " +
        ...
        db.execSQL(SQL_CREATE_CAREGORIES_TABLE);
    ...
    private void fillCategoiesTable() {
